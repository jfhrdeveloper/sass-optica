...
/* Botón flotante de WhatsApp — solo en la landing (el dashboard tiene su
   ...
   Server Component: es un `<a>` con un href fijo, no necesita JS en el
   cliente. El "tooltip" que aparece al pasar el mouse es CSS puro
   (`group-hover`), sin estado.
...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-30 flex items-center gap-2 rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 sm:bottom-6 sm:right-6"
    >
