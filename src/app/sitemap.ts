...
/* Solo páginas públicas e indexables — el dashboard/admin-panel quedan
   fuera (ver robots.ts). Las 4 pestañas de /legal se listan por separado
   porque tienen contenido realmente distinto (términos, privacidad,
   cookies, protección de datos), no son la misma página con un parámetro
   cosmético. */
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/legal?tab=cookies`, lastModified: ahora, changeFrequency: "yearly", priority: 0.2 },
